...
Windows-Cleaner (eigener CCleaner-Ersatz). C# / .NET 8 (`net8.0-windows`), drei Projekte in `WinCleaner.sln`: CLI (`WinCleaner\`), WPF-GUI (`WinCleaner.Gui\`, MVVM, ruft die CLI auf), xUnit-Tests (`WinCleaner.Tests\`).
